...
try {
    ...
    $stmt = $pdo->prepare("
      INSERT INTO events 
      (name, max_attendees, date, time, price, address, duration, duration_unit, description, audience, event_type, features, rating, images)
      VALUES
      (:name, :maxAtt, :date, :time, :price, :address, :duration, :durUnit, :desc, :aud, :etype, :feats, :rating, :imgs)
    ");
    $stmt->execute([
        ':name'     => $name,
        ':maxAtt'   => $maxAtt,
